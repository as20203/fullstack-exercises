  ...
  describe('When logged in', function () {
    ...
    describe('And if blogs exist', function () {
      ...
      it('A blog can be liked.', function () {
        cy.contains('mluukkai blog 1 Matti Luukkainen').contains('view').click()
        cy.contains('mluukkai blog 1 Matti Luukkainen').contains('like').click()
        cy.contains('mluukkai blog 1 Matti Luukkainen').should(
          'contain',
          'likes 1'
        )
      })
      ...
      it('A blog can be deleted.', function () {
        ...
        cy.contains('mluukkai blog 1 Matti Luukkainen')
          .contains('remove')
          .click()
        cy.contains('mluukkai blog 1 Matti Luukkainen').should('not.exist')
      })
      ...
      it('Blogs can be sorted by likes', function () {
        ...
        //Liked 3 times.
        cy.contains('mluukkai blog 2 Matti Luukkainen').contains('view').click()
        cy.contains('mluukkai blog 2 Matti Luukkainen').contains('like').click()
        cy.wait(500)
        cy.contains('mluukkai blog 2 Matti Luukkainen').contains('like').click()
        cy.wait(500)
        cy.contains('mluukkai blog 2 Matti Luukkainen').contains('like').click()
        ...
        //Liked 4 times
        cy.contains('mluukkai blog 3 Matti Luukkainen').contains('view').click()
        cy.contains('mluukkai blog 3 Matti Luukkainen').contains('like').click()
        cy.wait(500)
        cy.contains('mluukkai blog 3 Matti Luukkainen').contains('like').click()
        cy.wait(500)
        cy.contains('mluukkai blog 3 Matti Luukkainen').contains('like').click()
        ...
        //Liked 5 times.
        cy.contains('mluukkai blog 4 Matti Luukkainen').contains('view').click()
        cy.contains('mluukkai blog 4 Matti Luukkainen').contains('like').click()
        cy.wait(500)
        cy.contains('mluukkai blog 4 Matti Luukkainen').contains('like').click()
        cy.wait(500)
        cy.contains('mluukkai blog 4 Matti Luukkainen').contains('like').click()
